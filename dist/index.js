...
function usePagination(options = {}) {
  ...
  const [pageSize, setPageSizeState] = useState2(initialPageSize);
...
function Checkbox({ className, checked, ...props }) {
  return /* @__PURE__ */ jsx3(
    CheckboxPrimitive.Root,
    {
      ...
      checked,
      className: cn(
        "border-input dark:bg-input/30 data-checked:bg-primary data-checked:text-primary-foreground dark:data-checked:bg-primary data-checked:border-primary data-indeterminate:bg-primary data-indeterminate:text-primary-foreground data-indeterminate:border-primary aria-invalid:aria-checked:border-primary aria-invalid:border-destructive dark:aria-invalid:border-destructive/50 focus-visible:border-ring focus-visible:ring-ring/50 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 flex size-5 min-h-5 min-w-5 items-center justify-center rounded-none border group-has-disabled/field:opacity-50 focus-visible:ring-1 aria-invalid:ring-1 peer relative shrink-0 outline-none after:absolute after:-inset-x-3 after:-inset-y-2 disabled:cursor-not-allowed disabled:opacity-50",
        className
      ),
      ...props,
...
function CheckboxField({
  ...
  return /* @__PURE__ */ jsxs2(
    Label,
    {
      ...
      children: [
        /* @__PURE__ */ jsx5(Checkbox, { ...checkboxProps, className: cn(isCard && "mt-0.5", checkboxClassName) }),
        isCard && description !== void 0 ? /* @__PURE__ */ jsxs2("span", { className: "min-w-0 space-y-0.5", children: [
          /* @__PURE__ */ jsx5("span", { className: "block text-sm font-medium leading-snug", children: label }),
          /* @__PURE__ */ jsx5("span", { className: "block text-sm font-normal leading-snug text-muted-foreground", children: description })
        ] }) : /* @__PURE__ */ jsx5("span", { className: "min-w-0 text-sm font-normal leading-snug", children: label })
      ]
    }
  );
}
...
function ChipInput({
  ...
  return /* @__PURE__ */ jsxs3(
    "div",
    {
      ...
      children: [
        values.map((value, index) => /* @__PURE__ */ jsxs3(
          "span",
          {
            ...
            children: [
              /* @__PURE__ */ jsx6("span", { className: "break-all", children: value }),
              /* @__PURE__ */ jsx6(
                "button",
                {
                  type: "button",
                  ...
                  children: /* @__PURE__ */ jsx6(XIcon, { className: "size-3" })
                }
              )
            ]
          },
...
function CollapsibleSection({
  ...
  return /* @__PURE__ */ jsxs4(
    CollapsiblePrimitive.Root,
    {
      ...
      children: [
        /* @__PURE__ */ jsx7(CollapsiblePrimitive.CollapsibleTrigger, { asChild: true, children: /* @__PURE__ */ jsxs4(
          "div",
          {
            role: "button",
            tabIndex: 0,
            ...
            children: [
              ...
              /* @__PURE__ */ jsx7("span", { className: "text-base font-medium flex-1", children: title }),
              trailing !== void 0 && /* @__PURE__ */ jsx7("span", { className: "shrink-0", children: trailing })
            ]
          }
        ) }),
        /* @__PURE__ */ jsx7(CollapsiblePrimitive.CollapsibleContent, { className: contentClassName, children })
      ]
    }
  );
}
...
function DialogClose({ ...props }) {
  return /* @__PURE__ */ jsx8(DialogPrimitive.Close, { "data-slot": "dialog-close", ...props });
}
  ...
  return /* @__PURE__ */ jsxs5(DialogPortal, { children: [
    ...
    /* @__PURE__ */ jsxs5(
      DialogPrimitive.Content,
      {
        ...
        children: [
          children,
          showCloseButton && /* @__PURE__ */ jsx8(DialogPrimitive.Close, { "data-slot": "dialog-close", asChild: true, children: /* @__PURE__ */ jsxs5(IconButton, { className: "absolute top-2 right-2", children: [
...
function DialogFooter({
  ...
  return /* @__PURE__ */ jsxs5(
    "div",
    {
      ...
      children: [
        children,
        showCloseButton && /* @__PURE__ */ jsx8(DialogPrimitive.Close, { asChild: true, children: /* @__PURE__ */ jsx8(StandardButton, { children: "Close" }) })
      ]
    }
  );
}
...
function DropdownMenuTrigger({ ...props }) {
  return /* @__PURE__ */ jsx9(DropdownMenuPrimitive.Trigger, { "data-slot": "dropdown-menu-trigger", ...props });
}
...
function EmptyState({ children, className }) {
  return /* @__PURE__ */ jsx10("div", { className: cn("text-center py-16", className), children: /* @__PURE__ */ jsx10("p", { className: "text-muted-foreground", children }) });
}
...
function Field({ label, htmlFor, hint, error, className, labelClassName, children }) {
  return /* @__PURE__ */ jsxs6("div", { className: cn("space-y-1", className), children: [
    /* @__PURE__ */ jsx11(Label, { htmlFor, className: cn("text-sm font-medium", labelClassName), children: label }),
    children,
    error !== void 0 && /* @__PURE__ */ jsx11("p", { className: "text-sm text-destructive", children: error }),
    error === void 0 && hint !== void 0 && /* @__PURE__ */ jsx11("p", { className: "text-sm text-muted-foreground", children: hint })
  ] });
}
...
function InfoPopover({ children, label = "Info", align = "end", className }) {
  return /* @__PURE__ */ jsxs7(Popover, { children: [
    /* @__PURE__ */ jsx13(PopoverTrigger, { asChild: true, children: /* @__PURE__ */ jsx13(IconButton, { title: label, "aria-label": label, children: /* @__PURE__ */ jsx13(Info, { className: "size-4" }) }) }),
    /* @__PURE__ */ jsx13(PopoverContent, { align, className: cn("w-80", className), children })
  ] });
}
  ...
  return /* @__PURE__ */ jsxs8(
    "nav",
    {
      ...
      children: [
        ...
        showNumbers && /* @__PURE__ */ jsxs8("span", { className: "text-sm text-muted-foreground tabular-nums", children: [
          page + 1,
          " / ",
          totalPages,
          " (",
...
function LogBoard({
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsx16("div", { className: "text-sm text-muted-foreground py-8 text-center", children: loadingMessage });
  }
  if (rows.length === 0) {
    return /* @__PURE__ */ jsx16("div", { className: "text-sm text-muted-foreground py-8 text-center", children: emptyMessage });
  }
  return /* @__PURE__ */ jsxs9(Fragment3, { children: [
    /* @__PURE__ */ jsx16("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs9("table", { className: cn("w-full text-left", tableClassName), children: [
      /* @__PURE__ */ jsx16("thead", { children: /* @__PURE__ */ jsx16("tr", { className: "border-b border-border", children: columns.map((col) => /* @__PURE__ */ jsx16(
        "th",
        {
          className: cn(
      ...
      /* @__PURE__ */ jsx16("tbody", { children: rows.map((row, index) => {
        const key = rowKey(row);
        return /* @__PURE__ */ jsx16(Fragment2, { children: renderRow(row, {
          index,
...
function MetadataRow({ label, children, noBorder = false }) {
  return /* @__PURE__ */ jsxs10("div", { className: cn("flex items-center justify-between py-1.5", !noBorder && "border-b border-border"), children: [
    /* @__PURE__ */ jsx17("span", { className: "text-sm text-muted-foreground", children: label }),
    children
  ] });
}
...
function OverviewStatRow({ label, value, icon: Icon, accent }) {
  return /* @__PURE__ */ jsxs11("div", { className: "flex items-center justify-between gap-3", children: [
    /* @__PURE__ */ jsxs11("span", { className: "flex items-center gap-2 text-sm text-muted-foreground", children: [
      Icon !== void 0 && /* @__PURE__ */ jsx18(Icon, { className: cn("size-3.5 shrink-0", accent) }),
      label
    ] }),
    /* @__PURE__ */ jsx18("span", { className: "text-right text-sm font-semibold leading-tight tabular-nums", children: value })
  ] });
}
function OverviewSection({
  ...
  return /* @__PURE__ */ jsxs11("div", { className: "space-y-2 border-b border-border p-3 last:border-b-0", children: [
    title !== void 0 && /* @__PURE__ */ jsx18("div", { className: "text-sm uppercase tracking-wide text-muted-foreground", children: title }),
    children
  ] });
}
function OverviewPopover({
  ...
  return /* @__PURE__ */ jsxs11(Popover, { children: [
    ...
    /* @__PURE__ */ jsx18(PopoverContent, { align, className: cn("w-72 p-0", contentClassName), children })
  ] });
}
...
function PageHeader({ icon: Icon, title, subtitle, tabs, actions, children }) {
  return /* @__PURE__ */ jsxs12("div", { className: "px-5 py-3 border-b border-border flex-shrink-0 flex items-center gap-3", children: [
    Icon !== void 0 && /* @__PURE__ */ jsx19(Icon, { className: "size-6 text-muted-foreground" }),
    /* @__PURE__ */ jsx19("h1", { className: "text-xl font-semibold", children: title }),
    subtitle !== void 0 && /* @__PURE__ */ jsx19("span", { className: "text-sm text-muted-foreground", children: subtitle }),
    children,
    tabs,
    actions !== void 0 && /* @__PURE__ */ jsx19("div", { className: "ml-auto", children: actions })
  ] });
}
...
function PageLayout({
  ...
  return /* @__PURE__ */ jsxs13("div", { className: "flex flex-col flex-1 overflow-hidden w-full", children: [
    /* @__PURE__ */ jsx20(PageHeader, { icon, title, subtitle, children: headerActions }),
    /* @__PURE__ */ jsx20("div", { className: "flex-1 overflow-y-auto", children: /* @__PURE__ */ jsx20("div", { className: "px-4 py-3 space-y-4", children }) }),
    footer
  ] });
}
...
function SelectContent({
  ...
  return /* @__PURE__ */ jsx21(SelectPrimitive.Portal, { children: /* @__PURE__ */ jsxs14(
...
function renderOption(option) {
  ...
  return /* @__PURE__ */ jsxs14(SelectItem, { value: itemValue, className: option.className, children: [
    Icon !== void 0 && /* @__PURE__ */ jsx21(Icon, { className: "text-muted-foreground size-4 shrink-0", "aria-hidden": true }),
    option.label
  ] }, itemValue);
}
function DropdownSelect({
  ...
  return /* @__PURE__ */ jsxs14(Select, { value: internalValue, onValueChange: handleChange, disabled, children: [
    ...
    /* @__PURE__ */ jsx21(SelectContent, { className: contentClassName, children: options.map((item, index) => {
      if (isGroup(item)) {
        ...
        return /* @__PURE__ */ jsxs14(React3.Fragment, { children: [
          index > 0 && /* @__PURE__ */ jsx21(SelectSeparator, {}),
          /* @__PURE__ */ jsxs14(SelectGroup, { children: [
            item.label !== "" && /* @__PURE__ */ jsxs14(SelectLabel, { children: [
              GroupIcon !== void 0 && /* @__PURE__ */ jsx21(GroupIcon, { "aria-hidden": true }),
              item.label
            ] }),
...
var DEFAULT_PAGE_SIZES = [20, 50, 100, 200, 500];
...
function Panel({ children, className }) {
  return /* @__PURE__ */ jsx23("div", { className: cn("bg-card border border-border p-4 card-elevated", className), children });
}

// src/components/search-input.tsx
import { Search, X } from "lucide-react";
import { useCallback as useCallback2, useEffect as useEffect2, useRef, useState as useState5 } from "react";
...
function SearchInput({
  ...
  const debounced = debounceMs !== void 0 && debounceMs > 0;
  ...
  return /* @__PURE__ */ jsxs15("div", { className: cn("relative", className), children: [
    /* @__PURE__ */ jsx24(Search, { className: "absolute left-2.5 top-1/2 -translate-y-1/2 size-3.5 text-muted-foreground" }),
    /* @__PURE__ */ jsx24(
      Input,
      {
        ref,
        ...
        onKeyDown: onSubmit !== void 0 ? (e) => {
          if (e.key === "Enter") onSubmit();
        } : void 0,
        className: "pl-8 pr-8"
      }
    ),
    displayValue !== "" && /* @__PURE__ */ jsx24(IconButton, { onClick: handleClear, size: "icon-sm", className: "absolute right-1 top-1/2 -translate-y-1/2", children: /* @__PURE__ */ jsx24(X, {}) })
  ] });
}
  ...
  return /* @__PURE__ */ jsxs16(SheetPortal, { children: [
    ...
    /* @__PURE__ */ jsxs16(
      SheetPrimitive.Content,
      {
        ...
        children: [
          children,
          showCloseButton && /* @__PURE__ */ jsxs16(SheetPrimitive.Close, { className: "ring-offset-background focus:ring-ring data-[state=open]:bg-secondary absolute top-4 right-4 rounded-xs opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none", children: [
            /* @__PURE__ */ jsx26(XIcon3, { className: "size-4" }),
...
function SheetHeader({ className, ...props }) {
  return /* @__PURE__ */ jsx26("div", { "data-slot": "sheet-header", className: cn("flex flex-col gap-1.5 p-4", className), ...props });
}
function SheetFooter({ className, ...props }) {
  return /* @__PURE__ */ jsx26("div", { "data-slot": "sheet-footer", className: cn("mt-auto flex flex-col gap-2 p-4", className), ...props });
}
...
function Skeleton({ className, ...props }) {
  return /* @__PURE__ */ jsx27("div", { "data-slot": "skeleton", className: cn("bg-accent animate-pulse rounded-md", className), ...props });
}
...
function TooltipProvider({ delayDuration = 0, ...props }) {
  return /* @__PURE__ */ jsx28(TooltipPrimitive.Provider, { "data-slot": "tooltip-provider", delayDuration, ...props });
}
...
function TooltipContent({
  ...
  return /* @__PURE__ */ jsx28(TooltipPrimitive.Portal, { children: /* @__PURE__ */ jsxs17(
    TooltipPrimitive.Content,
    {
      ...
      children: [
        children,
        /* @__PURE__ */ jsx28(TooltipPrimitive.Arrow, { className: "bg-foreground fill-foreground z-50 size-2.5 translate-y-[calc(-50%_-_2px)] rotate-45 rounded-[2px]" })
      ]
    }
  ) });
}
...
function SidebarProvider({
  ...
  return /* @__PURE__ */ jsx29(SidebarStateContext.Provider, { value: stateValue, children: /* @__PURE__ */ jsx29(SidebarActionsContext.Provider, { value: actionsValue, children: /* @__PURE__ */ jsx29(TooltipProvider, { delayDuration: 0, children: /* @__PURE__ */ jsx29(
    "div",
    {
...
function Sidebar({
  ...
  if (isMobile) {
    return /* @__PURE__ */ jsx29(Sheet, { open: openMobile, onOpenChange: setOpenMobile, ...props, children: /* @__PURE__ */ jsxs18(
      SheetContent,
      {
        ...
        children: [
          /* @__PURE__ */ jsxs18(SheetHeader, { className: "sr-only", children: [
            /* @__PURE__ */ jsx29(SheetTitle, { children: "Sidebar" }),
            /* @__PURE__ */ jsx29(SheetDescription, { children: "Displays the mobile sidebar." })
          ] }),
          /* @__PURE__ */ jsx29("nav", { "aria-label": "Main navigation", className: "flex h-full w-full flex-col", children })
        ]
      }
    ) });
  }
...
function SidebarTrigger({ className, onClick, ...props }) {
  ...
  return /* @__PURE__ */ jsxs18(
    IconButton,
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ jsx29(PanelLeftIcon, {}),
        /* @__PURE__ */ jsx29("span", { className: "sr-only", children: "Toggle Sidebar" })
      ]
    }
  );
}
...
function SidebarMenuButton({
  ...
  return /* @__PURE__ */ jsxs18(Tooltip, { children: [
    ...
    /* @__PURE__ */ jsx29(TooltipContent, { side: "right", align: "center", ...tooltip })
  ] });
}
...
function SidebarMenuSkeleton({
  ...
  return /* @__PURE__ */ jsxs18(
    "div",
    {
      ...
      ...props,
      children: [
        showIcon && /* @__PURE__ */ jsx29(Skeleton, { className: "size-4 rounded-md", "data-sidebar": "menu-skeleton-icon" }),
        /* @__PURE__ */ jsx29(
          Skeleton,
          {
...
function StatCard({ label, value, sub }) {
  return /* @__PURE__ */ jsxs19("div", { className: "border border-border bg-card px-5 py-4 card-elevated", children: [
    /* @__PURE__ */ jsx30("div", { className: "text-sm text-muted-foreground uppercase tracking-wide", children: label }),
    /* @__PURE__ */ jsx30("div", { className: "text-2xl font-semibold mt-1", children: value }),
    sub !== void 0 && /* @__PURE__ */ jsx30("div", { className: "text-sm text-muted-foreground mt-0.5", children: sub })
  ] });
}
...
function TabNav({ items, ariaLabel }) {
  return /* @__PURE__ */ jsx32("nav", { "aria-label": ariaLabel, className: wrapperClasses, children: items.map((item) => /* @__PURE__ */ jsxs20(
    Link,
    {
      to: item.to,
      params: item.params,
...
function ButtonTabNav({ value, onValueChange, items, ariaLabel }) {
  return /* @__PURE__ */ jsx32("div", { role: "tablist", "aria-label": ariaLabel, className: wrapperClasses, children: items.map((item) => /* @__PURE__ */ jsxs20(
    "button",
    {
      type: "button",
      role: "tab",
...
function Table({
  ...
  return /* @__PURE__ */ jsx33("div", { "data-slot": "table-wrapper", className: cn("w-full overflow-x-auto", wrapperClassName), children: /* @__PURE__ */ jsx33("table", { "data-slot": "table", className: cn("w-full border-collapse text-sm", className), ...props }) });
}
function TableHeader({ className, ...props }) {
  return /* @__PURE__ */ jsx33("thead", { "data-slot": "table-header", className: cn("[&_tr]:border-b [&_tr]:border-border", className), ...props });
}
function TableBody({ className, ...props }) {
  return /* @__PURE__ */ jsx33("tbody", { "data-slot": "table-body", className: cn("[&_tr:last-child]:border-0", className), ...props });
}
...
function TableCell({
  ...
  return /* @__PURE__ */ jsx33("td", { "data-slot": "table-cell", className: cn("px-3 py-2 align-top", ALIGN_CLASS[align], className), ...props });
}
function SortableTableHead({
  ...
  return /* @__PURE__ */ jsx33(TableHead, { align, className: cn("p-0", className), children: /* @__PURE__ */ jsxs21(
    "button",
    {
      type: "button",
      onClick: () => {
      ...
      children: [
        label,
        isActive ? direction === "asc" ? /* @__PURE__ */ jsx33(ArrowUp, { className: "size-3" }) : /* @__PURE__ */ jsx33(ArrowDown, { className: "size-3" }) : /* @__PURE__ */ jsx33(ChevronsUpDown, { className: "size-3 opacity-40" })
      ]
    }
  ) });
}
function ExpandableRow({
  ...
  return /* @__PURE__ */ jsxs21(Fragment5, { children: [
    /* @__PURE__ */ jsxs21(TableRow, { className: cn("cursor-pointer", className), "aria-expanded": expanded, onClick: onToggle, children: [
      /* @__PURE__ */ jsx33(TableCell, { className: "w-6 pr-0", children: /* @__PURE__ */ jsx33(
        ChevronRight2,
        {
          className: cn(
    ...
    expanded && /* @__PURE__ */ jsx33(TableRow, { className: cn("bg-muted/30 hover:bg-muted/30", detailClassName), children: /* @__PURE__ */ jsx33(TableCell, { colSpan, children: detail }) })
  ] });
}
...
function Tabs({ className, ...props }) {
  return /* @__PURE__ */ jsx34(TabsPrimitive.Root, { "data-slot": "tabs", className, ...props });
}
...
function TabsContent({ className, ...props }) {
  return /* @__PURE__ */ jsx34(TabsPrimitive.Content, { "data-slot": "tabs-content", className: cn("flex-1 outline-none", className), ...props });
}
